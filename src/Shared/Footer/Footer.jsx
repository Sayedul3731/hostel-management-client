...
const Footer = () => {
    return (
        <div className="bg-[#491c16]">
            <footer className="footer p-10 max-w-7xl mx-auto text-white font-semibold">
                <nav>
                    <header className="footer-title">Services</header>
                    <a className="link link-hover">Foods</a>
                    <a className="link link-hover">Sleep Room</a>
                    <a className="link link-hover">Library</a>
                    <a className="link link-hover">Sports Equipment</a>
                </nav>
                <nav>
                    <header className="footer-title">Hostel</header>
                    <a className="link link-hover">About us</a>
                    <a className="link link-hover">Contact</a>
                    <a className="link link-hover">Seat Bookings</a>
                </nav>
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t   max-w-7xl mx-auto text-white border-base-300">
