    ...
    return (
        <div>
            ...
            <div className="mb-10">
                ...
                <h4 className="text-xl text-center font-medium mt-2">The main building of the hostel</h4>
            </div>
            <div>
                <Marquee>
                ...
                <h4 className="text-xl text-center font-medium mt-2 mb-10">Other Hostel Facilities</h4>
            </div>
        </div>
    );
};
