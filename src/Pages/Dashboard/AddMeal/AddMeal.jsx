    ...
    return (
        <div className="p-0 md:p-8">
            ...
            <form
                ...
                <button type="submit" className='text-center font-semibold   w-full mt-5 btn btn-outline py-2'>
                    Add Meal
                </button>
                <button onClick={handleSubmit(handleUpcomingMeal)} className='text-center font-semibold   w-full mt-5 btn btn-outline py-2'>
                    Upcoming Meal
                </button>
            </form>
        </div>
