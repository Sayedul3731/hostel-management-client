    ...
    return (
        <div>
            ...
            <div className="my-5 px-10 mb-10 flex justify-center">
                <button onClick={() => document.getElementById('update_modal').showModal()} type="submit" className="px-10 bg-red-500 py-2 text-white font-semibold rounded-sm">Edit</button>
            </div>
